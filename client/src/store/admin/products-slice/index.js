...
export const addNewProduct = createAsyncThunk(
  ...
  async (formData) => {
    const result = await axios.post(
      `${import.meta.env.VITE_API_URL}/api/admin/products/add`, // URL da API
      formData,
      {
        headers: {
...
export const fetchAllProducts = createAsyncThunk(
  ...
  async () => {
    const result = await axios.get(
      `${import.meta.env.VITE_API_URL}/api/admin/products/get` // URL da API
    );
...
export const editProduct = createAsyncThunk(
  ...
  async ({ id, formData }) => {
    const result = await axios.put(
      `${import.meta.env.VITE_API_URL}/api/admin/products/edit/${id}`, // URL da API
      formData,
      {
        headers: {
          "Content-Type": "application/json", // Tipo de conteúdo
...
export const deleteProduct = createAsyncThunk(
  ...
  async (id) => {
    const result = await axios.delete(
      `${import.meta.env.VITE_API_URL}/api/admin/products/delete/${id}` // URL da API
    );
